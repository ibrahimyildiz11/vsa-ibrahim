...
function start () {
    document.getElementById("btn_datum").addEventListener('click' , function(){
        let jaar = parseInt(document.getElementById("jaar").value);
        let maand = parseInt(document.getElementById("maand").value);
        let uitvoer = maanden_voluit[maand - 1] + " " + jaar + "\n\n";
        uitvoer += bouwHoofding() + "\n" + bouwKalender();
        document.getElementById("jouw_kalender").innerHTML = "Jouw kalender: " +  uitvoer;
        console.log(uitvoer);
    })
}
